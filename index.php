...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': 
    ...
    <style>
        ...
        .nid_books_header {
            text-align: center;
            margin-bottom: 50px;
            animation: nid_fade_in 1s ease-out;
        }
        ...
        .nid_books_grid {
            ...
            gap: 25px;
            animation: nid_fade_in_up 1s ease-out 0.3s both;
        }
        ...
        /* First book gets the red accent like in the original */
        /* .nid_book_item:first-child {
            background-color: #e74c3c;
            border-color: #c0392b;
        } */

        /* .nid_book_item:first-child:hover {
        ...
        .nid_book_item:first-child .nid_book_number {
            color: #ffffff;
            opacity: 0.9;
        }

        /* Mobile header layout */
        .nid_book_header_mobile {
            display: none;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* Mobile: Icon and book number on same line */
            .nid_book_header_mobile {
                display: flex;
                align-items: center;
                gap: 12px;
        ...
        .nid_book_item:hover .nid_book_number {
            color: #ffffff;
            opacity: 1;
        }
        /* End book details */
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TWL9D6CF" 
    ...
    <div class="row banner-mobile">
        <div class="col-12">
            <img src="./images/bannerImgM.png" alt="banner" class="banner-mobile-img w-100 ">
        </div>
    </div>
            ...
            <div class="row gy-4 align-items-center justify-content-end">
                ...
                <div class="col-md-6 col-12" id="form">
                    <div class="banner-right text-center mx-auto ms-lg-auto me-lg-0 mw-">
                        ...
                        <form method="post" enctype="multipart/form-data" id="brds_form">
                            <div class="col-12">
                            ...
                            <div class="col-12 ">
                                ...
                                <input type="hidden" name="orderid" value="1052" />
                                <input type="hidden" name="sitename" value="CEEDLP" />
